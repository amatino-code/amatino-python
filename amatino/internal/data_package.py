...
class DataPackage:
    ...
    @classmethod
    def from_object(data: Encodable, override_listing: bool = False) -> T:
        """
        Return a new instance of DataPackage initialised with a single Encodable
        object
        """
        return DataPackage(object_data=data, override_listing=override_listing)
